...
class NarrativeMethodStore(object):
    ...
    def ver(self):
        resp = self._call('NarrativeMethodStore.ver',
                          [])
        return resp[0]

    def status(self):
        resp = self._call('NarrativeMethodStore.status',
                          [])
        return resp[0]
    ...
    def list_methods_full_info(self, params):
        resp = self._call('NarrativeMethodStore.list_methods_full_info',
                          [params])
        return resp[0]

    def list_methods_spec(self, params):
        resp = self._call('NarrativeMethodStore.list_methods_spec',
                          [params])
        return resp[0]
    ...
    def get_method_full_info(self, params):
        resp = self._call('NarrativeMethodStore.get_method_full_info',
                          [params])
        return resp[0]
